"""
Django settings for festival_radio_project project.
...
SECRET_KEY = "dhx5wn$*jhu7zz1x6*t@r&xhi*c#*9juv(*e%dqvp^%w94c=qo"
...
WSGI_APPLICATION = "festival_radio_project.wsgi.application"
